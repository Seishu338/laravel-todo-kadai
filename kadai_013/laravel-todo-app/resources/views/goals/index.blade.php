        ...
        <div class="col">
            <div class="card bg-light">
                <div class="card-body d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center">
                        <div class="dropdown">
                            <a href="#" class="px-2 fs-5 fw-bold limk-dark text-decoration-none" data-bs-toggle="modal" data-bs-target="#addTodoModal{{$goal->id}}">+</a>
                            ...
                            <ul class="dropdown-menu dropdown-menu-end text-center" aria-labelledby="dropdownGoalNenuLink">
                ...
                <div class="card mx-2 mb-2">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <div class="dropdown">
                                <a href="#" class="dropdown-toggle px-1 fs-5 ew-bold link-dark text-decoration-none menu-icon" id="dropdownTodoMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">:</a>
